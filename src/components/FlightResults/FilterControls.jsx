...
const FilterControls = ({ onOpenModal }) => {
    return (
        <div className="flex gap-6 items-center max-md:w-full max-md:justify-between max-md:mt-4 max-sm:flex-col max-sm:gap-3">
            {/* Currency Selector */}
            <div className="inline-flex justify-center items-center gap-2.5 border w-[143px] h-[37px] p-2.5 rounded-xl border-[#E5E5E3] max-sm:w-full">
            ...
            <button
                onClick={onOpenModal}
                className="inline-flex h-[37px] justify-center items-center gap-2.5 shrink-0 border w-[152px] p-2.5 rounded-xl border-[#E5E5E3] max-sm:w-full hover:bg-gray-50 transition-colors"
            >
                <svg
                    width="24"
                    height="25"
