...
const values = [
    {
        ...
        description:
            "We prioritize customer satisfaction, hospitality, and passengers' comfort throughout every journey.",
    },
    {
        title: 'Excellence',
        description:
            'We maintain the highest levels of efficiency in all aspects of our journeys, from the moment you book your ticket to your arrival at your destination.',
    },
    {
        title: 'Professionalism',
        description:
            'Our team is distinguished by professionalism, high skill levels (highest standards), and a commitment to providing exceptional customer service.',
    },
    {
        title: 'Teamwork',
        description:
            "We believe great journeys are made possible by great teams. Our team works cooperatively and passionately to provide the highest levels of service and meet passengers' needs, ensuring their comfort throughout the journey.",
    },
];
const sections = [
    {
        ...
        content: (
            <div className="z-10 h-auto md:h-full flex flex-col md:flex-row-reverse  items-baseline md:items-center justify-center gap-1 md:gap-8">
                ...
                <div className="flex-1 min-w-[300px] z-10 p-6 md:p-8">
                    <h2 className="text-[#2A2A2A] text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl font-bold text-center mb-4 md:mb-6 leading-tight">Our Core Values</h2>
