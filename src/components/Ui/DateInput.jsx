...
export default function CustomDateInput({value, onChange }) {
    ...
    return (
            ...
            {!isFocused && !value && (
                <>
                    <div
                        ...
                        className="absolute  gap-4 inset-0 bg-100 text-600 text-sm px-4 py-3 rounded-xl cursor-text z-10 flex items-center justify-between
        ...
        onChange={(e) => onChange(e.target.value)}
                ...
                className="w-full bg-100 text-600 text-sm px-4 py-3 pr-10 rounded-xl  focus:outline-none 
                border border-gray-300
