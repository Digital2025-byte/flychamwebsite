...
const Page = () => {
    const cardData = [
        ...
        {
            img: cardimg3.src,
            title: "Towards the Syrian Community",
            desc:
                "We believe in supporting the Syrian community through various community initiatives, and sponsoring and support cultural events and local associations, as well as entrepreneurship, youth, and women's empowerment programs.",
        },
        {
            img: cardimg4.src,
            title: "Training & Development",
            desc:
                "We believe in nurturing talent from within. Through specialized aviation training programs and skills development workshops, we aim to build a new generation of aviation professionals, equipping our team members with the tools to succeed locally and globally via establishing Fly Cham own Training Center.",
            isReversed: true,
        },
        {
            img: cardimg5.src,
            title: "Towards Future Leaders",
            desc:
                "Our vision includes creating meaningful opportunities for the youth. By fostering leadership, innovation, and entrepreneurship, to inspire the next wave of Syrian change-makers — in aviation and beyond.",
        },
    ];
            ...
            <div className="hidden xl:block relative w-full overflow-visible bg-white">
                    ...
                    <div className="absolute top-[13%] text-white text-center px-6 md:px-20 max-w-5xl space-y-8">
                        ...
                        <Reveal delay={0.2}>
                            ...
                            <p className="text-[18px] break-words">
                                Fly Cham is a Syrian-Emirati joint private commercial airline, officially launched in May 2025, with a bold vision to elevate the aviation sector across Syria and the region.<br />Built on two core pillars, passenger air travel and air cargo transportation, Fly Cham operates an expanding network of domestic and international flight routes, tailored to meet the growing demands of the Syrian market and customers' expectations
                            </p>
                        </Reveal>
                    </div>
                ...
                <div className="absolute top-[37%] left-[15%] flex items-start justify-between w-[80%]">
                    ...
                    <Reveal delay={0.3}>
                        ...
                        <div className="text-[#2A2A2A] text-[28px] font-bold  leading-[33px] tracking-[0.07em] max-w-md">
                            Get ready to discover new cities in your own style
                        </div>
                    </Reveal>
                    ...
                    <Reveal delay={0.3}>
                        ...
                        <div className="text-white  max-w-sm flex justify-center items-center flex-col ">
                            <p className="text-[18px] text-start font-medium  tracking-[0.04em] break-words mb-1">
                                learn about our modern fleet equipped with the latest technologies to provide a safe and comfortable travel experience
                            </p>
                            <button
                            ...
                            >
                                Discover More
                                <span className="text-lg"><CiDesktopMouse1 /></span>
                            </button>
                        </div>
                ...
                <div className="absolute bottom-[1%] left-[15%] flex items-start justify-between w-[80%]">
                    ...
                    <Reveal delay={0.2}>
                        ...
                        <div className="text-[#2A2A2A] text-[28px] font-bold  leading-[33px] tracking-[0.07em] max-w-md">
                            Comfort, care, and excellence in every detail                </div>
                    </Reveal>
                    ...
                    <Reveal delay={0.2}>
                        ...
                        <div className="text-black  max-w-sm flex justify-center items-center flex-col ">
                            <p className="text-[18px] text-start font-medium  tracking-[0.04em] break-words mb-1">
                                learn about our modern fleet equipped with the latest technologies to provide a safe and comfortable travel experience                    </p>
                            <button
                                className="flex items-center justify-center gap-2 text-white text-sm font-semibold"
                                style={{
                                    width: '158px',
                    ...
                    <div className="pt-12 px-6 space-y-6 text-white">
                        ...
                        <Reveal delay={0.2}>
                            <p className="text-[16px] font-medium leading-relaxed">
                                Fly Cham is a Syrian-Emirati joint private commercial airline, officially launched in May 2025, with a bold vision to elevate the aviation sector across Syria and the region.
                                Built on two core pillars, passenger air travel and air cargo transportation, Fly Cham operates an expanding network of domestic and international flight routes, tailored to meet the growing demands of the Syrian market and customers' expectations.
                            </p>
                        </Reveal>
                    </div>
                    {/* Middle Text Block */}
                    <div className="py-12 px-6 space-y-6">
                        ...
                        <Reveal delay={0.4}>
                            <div className="text-white text-[15px] font-medium space-y-4">
                                ...
                                >
                                    Discover More <CiDesktopMouse1 className="text-lg" />
                                </button>
                            </div>
                        </Reveal>
                    </div>
                ...
                <div className="bg-white px-6 pb-20 space-y-6">
                    <Reveal delay={0.2}>
                        <h2 className="text-[22px] font-bold text-[#2A2A2A]">
                            Comfort, care, and excellence in every detail
                        </h2>
                    </Reveal>
                    <Reveal delay={0.3}>
